...
<head>
    ...
    <title>Patient Records - Sunrise Dental</title>
...
<div class="container py-4">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <small class="text-muted">Search patients and view their full appointment history</small>
        </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="<%= request.getContextPath() %>/admin/patients" method="post" class="d-inline">
    ...
    <div class="card card-main mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="<%= request.getContextPath() %>/admin/patients" class="btn btn-sm btn-outline-secondary">
